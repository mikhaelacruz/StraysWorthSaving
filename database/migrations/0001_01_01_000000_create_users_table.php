...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('strays', function (Blueprint $table) {
            ...
            $table->text('photo_url')->default('https://www.pngall.com/wp-content/uploads/10/Dog-Pet-PNG-Cutout.png');
            $table->timestamps();
        });
        Schema::create('adoptionrequests', function (Blueprint $table) {
            $table->id();
            $table->foreignId('stray_id')->references('id')->on('strays')->onDelete('cascade');
            $table->string('name');
            $table->string('email');
